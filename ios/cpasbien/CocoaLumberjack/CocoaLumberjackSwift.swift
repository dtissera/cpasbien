...
extension DDLog {
    class func logError(message: @autoclosure () -> String, function: String = __FUNCTION__,
        file: String = __FILE__, line: UInt = __LINE__) {
            DDLog.log(.Error, message: message, function: function, file: file, line: line)
    }
    
    class func logWarn(message: @autoclosure () -> String, function: String = __FUNCTION__,
        file: String = __FILE__, line: UInt = __LINE__) {
            DDLog.log(.Warning, message: message, function: function, file: file, line: line)
    }
    
    class func logInfo(message: @autoclosure () -> String, function: String = __FUNCTION__,
        file: String = __FILE__, line: UInt = __LINE__) {
            DDLog.log(.Info, message: message, function: function, file: file, line: line)
    }
    
    class func logDebug(message: @autoclosure () -> String, function: String = __FUNCTION__,
        file: String = __FILE__, line: UInt = __LINE__) {
            DDLog.log(.Debug, message: message, function: function, file: file, line: line)
    }
    
    class func logVerbose(message: @autoclosure () -> String, function: String = __FUNCTION__,
        file: String = __FILE__, line: UInt = __LINE__) {
            DDLog.log(.Verbose, message: message, function: function, file: file, line: line)
    }
}
...
@objc
class DDLogConfigurationSwift: NSObject {
